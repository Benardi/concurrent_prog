...
* Code can be found at `go-code/first_return.go`

```{c, eval=FALSE, code = readLines(here::here("go-code/first_return.go"))}
...
* Code can be found at `go-code/combined_return.go`

```{c, eval=FALSE, code = readLines(here::here("go-code/combined_return.go"))}
...
* Code can be found at `go-code/return_first-2a.go`


```{c, eval=FALSE, code = readLines(here::here("go-code/return_first-2a.go"))}
...
* Code can be found at `go-code/return_first-2b.go`

```{c, eval=FALSE, code = readLines(here::here("go-code/combined_return-2b.go"))}
...
* Code can be found at `code/CreateNThreads.java`

```{c, eval=FALSE, code = readLines(here::here("code/CreateNThreads.java"))}
...
* Code can be found at `go-code/goroutines.go`

```{c, eval=FALSE, code = readLines(here::here("go-code/goroutines.go"))}
