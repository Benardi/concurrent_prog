...
* Code can be found at `java-code/src/ex_04/ReturnFirst.java`

<br>

```{r, eval=FALSE, code = readLines(here::here("java-code/src/ex_04/ReturnFirst.java"))}
...
* Code can be found at `java-code/src/ex_04/ReturnFirstCombined.java`

<br>


```{r, eval=FALSE, code = readLines(here::here("java-code/src/ex_04/ReturnFirstCombined.java"))}
...
* Code used to generate dataset can be found at `java-code/src/ex_05/Main.java`
